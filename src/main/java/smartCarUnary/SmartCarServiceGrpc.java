...
public final class SmartCarServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<smartCarUnary.SmartcarUnary.AccidentAlertRequest,
      smartCarUnary.SmartcarUnary.AccidentAlertResponse> getSendAccidentAlertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendAccidentAlert",
      requestType = smartCarUnary.SmartcarUnary.AccidentAlertRequest.class,
      responseType = smartCarUnary.SmartcarUnary.AccidentAlertResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<smartCarUnary.SmartcarUnary.AccidentAlertRequest,
      smartCarUnary.SmartcarUnary.AccidentAlertResponse> getSendAccidentAlertMethod() {
    io.grpc.MethodDescriptor<smartCarUnary.SmartcarUnary.AccidentAlertRequest, smartCarUnary.SmartcarUnary.AccidentAlertResponse> getSendAccidentAlertMethod;
      ...
      synchronized (SmartCarServiceGrpc.class) {
        if ((getSendAccidentAlertMethod = SmartCarServiceGrpc.getSendAccidentAlertMethod) == null) {
          SmartCarServiceGrpc.getSendAccidentAlertMethod = getSendAccidentAlertMethod = 
              io.grpc.MethodDescriptor.<smartCarUnary.SmartcarUnary.AccidentAlertRequest, smartCarUnary.SmartcarUnary.AccidentAlertResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "smartCarUnary.SmartCarService", "sendAccidentAlert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  smartCarUnary.SmartcarUnary.AccidentAlertRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  smartCarUnary.SmartcarUnary.AccidentAlertResponse.getDefaultInstance()))
  ...
  public static abstract class SmartCarServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendAccidentAlert(smartCarUnary.SmartcarUnary.AccidentAlertRequest request,
        io.grpc.stub.StreamObserver<smartCarUnary.SmartcarUnary.AccidentAlertResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                smartCarUnary.SmartcarUnary.AccidentAlertRequest,
                smartCarUnary.SmartcarUnary.AccidentAlertResponse>(
  ...
  public static final class SmartCarServiceBlockingStub extends io.grpc.stub.AbstractStub<SmartCarServiceBlockingStub> {
    ...
    /**
     */
    public smartCarUnary.SmartcarUnary.AccidentAlertResponse sendAccidentAlert(smartCarUnary.SmartcarUnary.AccidentAlertRequest request) {
  ...
  public static final class SmartCarServiceFutureStub extends io.grpc.stub.AbstractStub<SmartCarServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<smartCarUnary.SmartcarUnary.AccidentAlertResponse> sendAccidentAlert(
        smartCarUnary.SmartcarUnary.AccidentAlertRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_ACCIDENT_ALERT:
          serviceImpl.sendAccidentAlert((smartCarUnary.SmartcarUnary.AccidentAlertRequest) request,
              (io.grpc.stub.StreamObserver<smartCarUnary.SmartcarUnary.AccidentAlertResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SmartCarServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return smartCarUnary.SmartcarUnary.getDescriptor();
    }
